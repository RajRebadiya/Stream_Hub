class App {
    ...
    initPortletCard() {
        (document
            .querySelectorAll('[data-action="card-close"]')
            .forEach((i) => {
            ...
            document
                .querySelectorAll('[data-action="card-toggle"]')
                .forEach((i) => {
                    i.addEventListener("click", (e) => {
                        e.preventDefault();
                        e = i.closest(".card");
            ...
            document
                .querySelectorAll('[data-action="card-refresh"]')
                .forEach((e) => {
    ...
    initSidenavMenu() {
        ...
        if (s) {
            s.querySelectorAll("li [data-bs-toggle='collapse']").forEach(
                (e) => {
...
class LayoutCustomizer {
    ...
    initSwitchListener() {
        var e = (e, t) => {
            ...
            e =
                ...
                e('input[name="dir"]', (e) =>
                    this.changeLayoutDirection(e.value),
                ),
    ...
    activeThemeDropdownItem() {
        var e = document.querySelectorAll(
            '.dropdown-item [name="data-bs-theme"]',
        );
        ...
        document.querySelectorAll("[data-provider]").forEach((e) => {
            ...
            "flatpickr" === t
                ? (i["data-date-format"] &&
                  ...
                  i["data-altFormat"] &&
                      ((o.altInput = !0),
                      (o.altFormat = i["data-altFormat"].value)),
                ...
                : "timepickr" === t &&
                  ...
                  i["data-time-inline"] &&
                      ((o.inline = !0),
                      (o.defaultDate = i["data-time-inline"].value)),
                  flatpickr(e, o));
        });
    }
    initTouchSpin() {
...
class I18nManager {
    constructor({
        ...
        ((this.selectedLanguage =
            sessionStorage.getItem("__THEME_LANG__") || e),
            (this.langPath = t),
        ...
        if (this.element) {
            ...
            if (e) {
                e = e
                    ...
                    .map((e) => e.trim())
                    .map((e) =>
                        e.startsWith("#") || e.includes("rgb") ? e : theme(e),
                    );
                ...
                this.element
                    ? (this.chart && this.chart.destroy(),
                      ...
                      (this.chart = new Chart(this.element, {
                          ...
                          options: {
                              ...structuredClone(
                                  CustomChartJs.getDefaultOptions(),
                              ),
                              ...(i || {}),
                          },
                          plugins: o || [],
