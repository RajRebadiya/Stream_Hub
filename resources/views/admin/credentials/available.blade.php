        ...
        <div class="container-fluid">
            <div class="page-title-head d-flex align-items-center">
                <div class="flex-grow-1">
                    <h4 class="page-main-title m-0">Available Credentials</h4>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 text-success">{{ $statistics['available'] ?? 0 }}</h3>
                                </div>
                                <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <h4 class="card-title">Available Credentials</h4>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-3 border-bottom">
                                <form action="{{ route('admin.credentials.available') }}" method="GET">
                                    <div class="row g-3">
                                        <div class="col-md-10">
                                            ...
                                            <tr>
                                                <td colspan="6" class="text-center py-4">
                                                    <div class="py-4">
                                                        ...
                                                        <p class="text-muted mb-0">No available credentials found</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
