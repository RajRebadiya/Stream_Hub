        ...
        <div class="container-fluid">
            <div class="page-title-head d-flex align-items-center">
                <div class="flex-grow-1">
                    <h4 class="page-main-title m-0">Add Subscription Plan</h4>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('duration_months') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ old('duration_months') == 1 ? 'selected' : '' }}>1
                                                Month
                                            </option>
                                            <option value="3" {{ old('duration_months') == 3 ? 'selected' : '' }}>3
                                                Months</option>
                                            <option value="6" {{ old('duration_months') == 6 ? 'selected' : '' }}>6
                                                Months</option>
                                            <option value="12" {{ old('duration_months') == 12 ? 'selected' : '' }}>12
                                                Months</option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ old('discount_percentage') }}" placeholder="0.00" readonly>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="max_screens" name="max_screens" value="{{ old('max_screens', 1) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('quality') is-invalid @enderror" id="quality"
                                            ...
                                            <option value="SD" {{ old('quality') == 'SD' ? 'selected' : '' }}>SD
                                                (480p)
                                            </option>
                                            <option value="HD" {{ old('quality') == 'HD' ? 'selected' : '' }}>HD
                                                (720p)
                                            </option>
                                            <option value="Full HD" {{ old('quality') == 'Full HD' ? 'selected' : '' }}>
                                                Full HD (1080p)</option>
                                            <option value="4K" {{ old('quality') == '4K' ? 'selected' : '' }}>4K Ultra
                                                HD
                                            </option>
                                        </select>
                                        @error('quality')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('stock_available', 0) }}" min="0" placeholder="0"
                                            required>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="fw-semibold" id="summary-original">₹0.00</span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">Selling Price:</span>
                                    <span class="fw-semibold text-success" id="summary-selling">₹0.00</span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="text-muted">You Save:</span>
                                    <span class="fw-semibold text-danger" id="summary-save">₹0.00 (0%)</span>
                                </div>
                            </div>
                        </div>
                    </div>
